...
<head>
    ...
    <title>Masuk - {{ config('app.name', 'Lentera Aksara') }}</title>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transition-colors duration-300">
                    ...
                    <div class="flex items-center justify-between">
                        <label for="remember_me" class="inline-flex items-center cursor-pointer">
                            <input id="remember_me" 
                                   type="checkbox" 
                                   name="remember"
                                   class="rounded border-gray-300 dark:border-gray-600 text-[#4B5320] dark:text-[#9acd32] focus:ring-[#4B5320] dark:focus:ring-[#9acd32] transition-colors">
                            <span class="ml-2 text-sm text-gray-600 dark:text-gray-400">Ingat saya</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-[#4B5320] dark:text-[#9acd32] hover:underline transition-colors">
                                Lupa password?
                            </a>
                        @endif
                    </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-semibold text-[#4B5320] dark:text-[#9acd32] hover:underline transition-colors">
                            Daftar sekarang
                        </a>
                    </p>
                </div>
