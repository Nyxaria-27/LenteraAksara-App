...
<head>
    ...
    <title>Reset Password - {{ config('app.name', 'Lentera Aksara') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-[#2F4F4F] dark:text-gray-100 mb-2">Reset Password</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Buat password baru untuk akun Anda</p>
            </div>
