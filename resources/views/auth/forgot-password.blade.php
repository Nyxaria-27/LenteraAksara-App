...
<head>
    ...
    <title>Lupa Password - {{ config('app.name', 'Lentera Aksara') }}</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-[#2F4F4F] dark:text-gray-100 mb-2">Lupa Password</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400">Kami akan mengirimkan link reset password ke email Anda</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 transition-colors duration-300">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-sm text-[#4B5320] dark:text-[#9acd32] hover:underline transition-colors">
